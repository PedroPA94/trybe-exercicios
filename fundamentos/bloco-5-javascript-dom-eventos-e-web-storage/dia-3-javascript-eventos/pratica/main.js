...
// A caixa tem a classe "tech", que possui a propriedade css translateY em -20px. Essa propriedade move a caixa para cima.
...
function changeTech(event) {
    document.querySelector(".tech").className = "";
...
myWebpage.addEventListener('dblclick', function () {
        window.location.assign('https://pedropa94.github.io/');
    });
myWebpage.addEventListener('mouseenter', () => {

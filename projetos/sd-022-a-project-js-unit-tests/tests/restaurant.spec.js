...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    const test3 = createMenu(testMenu);
    expect(createMenu({ food: {}, drink: {} }).fetchMenu()).toEqual({ food: {}, drink: {} });
    expect(test3.fetchMenu()).toEqual(testMenu);
    ...
    // ```
    const test4 = createMenu(testMenu);
    ...
    // ```
    const test5 = createMenu(testMenu);
    test5.order('coxinha')
    ...
    // ```
    const test6 = createMenu(testMenu);
    test6.order('coxinha');
    test6.order('agua');
    test6.order('sopa');
    test6.order('sashimi');
    expect(test6.consumption).toEqual(['coxinha', 'agua', 'sopa', 'sashimi']);
    ...
    // ```
    const test7 = createMenu(testMenu);
    test7.order('coxinha');
    test7.order('agua');
    test7.order('coxinha');
    ...
    // ```
    const test8 = createMenu(testMenu);
    test8.order('coxinha');
    test8.order('agua');
    test8.order('coxinha');
    expect(test8.pay()).toBeCloseTo(12.87)
